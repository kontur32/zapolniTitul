...
declare
  ...
  (:
    ...
    http://localhost:9984/zapolnititul/api/v2/users/6/reports/9b4cbc2c-a0a4-4794-a5cf-96291a7ebb0e/complete?template=5cca0292-925c-46cc-befa-94904f273cbc&inst=43470160-e788-43f1-9a4d-0c34e8d3a405
    
    Шаблон с таблицей
    http://localhost:9984/zapolnititul/api/v2/users/6/reports/1afcc0d7-bf56-4bad-80ec-d3a2bda697ec/complete?template=5cca0292-925c-46cc-befa-94904f273cbc 
   :)
function 
  ...
  )
{
  ...
  let $queryString as xs:string := fetch:text( "http://localhost:9984/zapolnititul/api/v2/users/" || $userID || "/reports/" || $reportID || "/query" )
  
  let $template as xs:base64Binary := fetch:binary(  "http://localhost:9984/zapolnititul/api/v2/users/" || $userID || "/reports/" || $reportID || "/template" )
