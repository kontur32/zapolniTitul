...
declare 
  %public
variable $config:param := function( $param as xs:string ) as xs:string{
...
declare
  %public
function config:userData( $userID as xs:string ) as element( table )*  {
   config:usersData()[ @userID/data() = $userID ]
};